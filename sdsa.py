...
#Game Backgrounds
bg1 = pygame.image.load("C:/Users/MUHAMMAD RAFAY/Downloads/SnakeItUpLogoTiles-Background.png")
...
#GameOverScreen
           ...
           pygame.draw.rect(gameWindow, light_pink, [food_x, food_y, snake_size, snake_size])
           head = []
           head.append(snake_x)
           head.append(snake_y)
           ...
           if snake_x<0 or snake_x>screen_width or snake_y<0 or snake_y>screen_height:
               ...
               pygame.mixer.music.play(100)
               pygame.mixer.music.set_volume(.6)
           plot_snake(gameWindow, light_pink, snk_list, snake_size)
       pygame.display.update()
       clock.tick(fps)
   pygame.quit()
   quit()
